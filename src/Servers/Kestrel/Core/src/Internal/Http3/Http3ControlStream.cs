...
namespace Microsoft.AspNetCore.Server.Kestrel.Core.Internal.Http3
{
    ...
    {
        private const int ControlStreamType = 0;
        private const int EncoderStreamType = 2;
        private const int DecoderStreamType = 3;
        ...
        public long StartExpirationTicks { get; set; }
        public bool HasStarted => _headerType >= 0;
        ...
        public async Task ProcessRequestAsync<TContext>(IHttpApplication<TContext> application) where TContext : notnull
        {
            ...
            try
            {
                _headerType = await TryReadStreamIdAsync();

                _context.StreamLifetimeHandler.OnStreamStarted(this);
